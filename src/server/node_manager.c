 ...
 *
 * @param[in]	stream	-	data (tpp) stream open from Mom on which to read the msg
...
/**
 * @brief
 * 		receive a job_obit IS message from a Mom.
 *
...
/**
 * @brief
 * 		Input is coming from another server (MOM) over a DIS tpp stream.
 *
 * @par
